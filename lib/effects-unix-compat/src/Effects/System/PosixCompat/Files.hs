...
--
-- @since 0.1
module Effects.System.PosixCompat.Files
  ( -- * Effect
...
--
-- @since 0.1
class (Monad m) => MonadPosixCompatFiles m where
...
-- | @since 0.1
instance MonadPosixCompatFiles IO where
...
-- | @since 0.1
instance (MonadPosixCompatFiles m) => MonadPosixCompatFiles (ReaderT e m) where
